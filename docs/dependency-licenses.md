...
Generated from Cargo.lock-resolved cargo metadata. Includes target-specific dependencies, not all of which ship on macOS/Windows. License expressions are upstream metadata, not legal approval.
...
| dengex-agent-core | 0.1.0 | MIT |
| dengex-desktop | 0.1.0 | MIT |
| dengex-platform-windows | 0.1.0 | MIT |
| dengex-transport | 0.1.0 | MIT |
